...
no_CD_file = "D:\\DR Testing\\FullData, no CD, short guide file\\frac_new_output.tsv"
CD_file = "D:\\DR Testing\\FullData, CD - interfile, short guide file\\frac_new_output.tsv"
intra_file = "D:\\DR Testing\\FullData, CD - intrafile, short guide file\\frac_new_output.tsv"

lipid_no_CD_file = "D:\\DR Testing\\LipidData, no CD, short guide file\\frac_new_output.tsv"
lipid_CD_file = "D:\\DR Testing\\LipidData, CD - interfile, short guide file\\frac_new_output.tsv"
lipid_intra_file = "D:\\DR Testing\\LipidData, CD - intrafile, short guide file\\frac_new_output.tsv"
...
def main():
    ...
    lipid_no_cd.to_csv("D:\\DR Testing\\analysis\\lipid_frac_new_output_no_chromatography.tsv", sep="\t", index=False)
    lipid_cd.to_csv("D:\\DR Testing\\analysis\\lipid_frac_new_output_with_chromatography_inter.tsv", sep="\t", index=False)
    lipid_intra.to_csv("D:\\DR Testing\\analysis\\lipid_frac_new_output_with_chromatography_intra.tsv", sep="\t", index=False)
